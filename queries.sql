...
SELECT ANIMALS.NAME FROM ANIMALS INNER JOIN VISITS ON ANIMALS.ID = VISITS.ANIMALS_ID INNER JOIN VETS ON VETS.ID = ANIMALS.ID WHERE VETS.NAME = 'William Tatcher' ORDER BY VISITS.VISIT_DATE DESC LIMIT 1;
